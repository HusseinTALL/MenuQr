...
define(['./workbox-1d2bc1f6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/data\/menu\.json$/, new workbox.NetworkFirst({
    "cacheName": "menuqr-menu-data-v1.0.0",
  ...
  workbox.registerRoute(/^https:\/\/res\.cloudinary\.com\/.*/, new workbox.CacheFirst({
    "cacheName": "menuqr-cloudinary-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 150,
      ...
      statuses: [0, 200]
    }), new workbox.BackgroundSyncPlugin("image-queue", {
      maxRetentionTime: 1440
    })]
  }), 'GET');
  workbox.registerRoute(/^https:\/\/images\.unsplash\.com\/.*/, new workbox.CacheFirst({
    "cacheName": "menuqr-unsplash-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 150,
      maxAgeSeconds: 2592000,
      purgeOnQuotaError: true
  ...
  workbox.registerRoute(/^https:\/\/fonts\.googleapis\.com\/.*/, new workbox.StaleWhileRevalidate({
    "cacheName": "menuqr-gfonts-styles-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 10,
  ...
  workbox.registerRoute(/^https:\/\/fonts\.gstatic\.com\/.*/, new workbox.CacheFirst({
    "cacheName": "menuqr-gfonts-webfonts-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 30,
      maxAgeSeconds: 31536000
    }), new workbox.CacheableResponsePlugin({
  ...
  workbox.registerRoute(/\.(?:js|css)$/, new workbox.CacheFirst({
    "cacheName": "menuqr-static-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 80,
      maxAgeSeconds: 2592000,
      purgeOnQuotaError: true
  ...
  workbox.registerRoute(/\.(?:png|jpg|jpeg|svg|gif|webp|ico)$/, new workbox.CacheFirst({
    "cacheName": "menuqr-images-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 120,
      maxAgeSeconds: 2592000,
      purgeOnQuotaError: true
  ...
  workbox.registerRoute(/^https?:\/\/.*/, new workbox.StaleWhileRevalidate({
    "cacheName": "menuqr-others-v1.0.0",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 50,
